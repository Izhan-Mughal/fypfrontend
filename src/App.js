...
import Profile from 'dashboard/app/views/dashboard/Profile';
import { Chatbox, MatxTheme } from 'dashboard/app/components';
import Funding from 'dashboard/app/views/dashboard/Funding';
import InboxDash from 'dashboard/app/views/dashboard/Inbox';
import DashHome from 'dashboard/app/views/dashboard/DashHome';
