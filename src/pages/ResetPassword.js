        ...
        onSubmit: (values) => {
            ...
            const handleApiCall = async () => {
                ...
                try {
                    ...
                    console.log(apiResponse.messsage)
                    toast(apiResponse.messsage);
              ...
              <DividerTextContainer>
                <DividerText>Or Sign in with your e-mail</DividerText>
                                ...
                                <Form onSubmit={handleSubmit}>
                                    <label htmlFor="password" className="mb-0 small" >Enter New Password *</label>
                                    <Input name="password" onChange={handleChange} onBlur={handleBlur} value={values.password} id="password" type="password" placeholder="New Password" />
                                    {errors.password && touched.password ? <div class="alert alert-danger mt-2" role="alert">
                                        {errors.password}
                                    </div> : ""}
                                    <label htmlFor="Newpassword" className="mb-0 small" >Confirm Password *</label>
                                    <Input name="Newpassword" onChange={handleChange} onBlur={handleBlur} value={values.Newpassword} id="Newpassword" type="password" placeholder="Confirm Password" />
                                    {errors.Newpassword && touched.Newpassword ? <div class="alert alert-danger mt-2" role="alert">
                                        {errors.Newpassword}
                                    </div> : ""}
